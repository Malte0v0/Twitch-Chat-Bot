...
export class ReminderModel {
  ...
  async notifyDeliver() {
    const targetUserName = this.userRepository.getUserName(this.targetUserId);

    const senderUserName = this.userRepository.getUserName(this.senderUserId);

    const targetName =
      this.senderUserId != this.targetUserId ? senderUserName : "yourself";
